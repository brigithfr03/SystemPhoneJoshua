...
$telefono = "921206096";
$email = "systemphonejoshua@gmail.com";
...
$pdf->addClientAdresse($regv->cliente,"Domicilio: ".$regv->direccion,$regv->tipo_documento.": ".$regv->num_documento,"Email: ".$regv->email,"Telefono: ".$regv->telefono);
