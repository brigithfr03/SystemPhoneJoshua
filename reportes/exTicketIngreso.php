...
$direccion = "Av. Dias barcenas 1013";
$telefono = "921206096";
...
<table border="0" align="center" width="300px">
    ...
    <tr>
        ...
        <td>Sucursal: <?php echo $reg->cliente; ?></td>
    </tr>
    <tr>
        <td><?php echo $reg->tipo_documento.": ".$reg->num_documento; ?></td>
    </tr>
    <tr>
        <td>Nº de Salida: <?php echo $reg->serie_comprobante." - ".$reg->num_comprobante ; ?></td>
    </tr>    
</table>
<br>
...
<table border="0" align="center" width="300px">
    ...
    <tr>
      <td colspan="3" align="center">Gestor de Almacén</td>
    </tr>
    <tr>
      <td colspan="3" align="center">Abancay - Perú</td>
    </tr>
