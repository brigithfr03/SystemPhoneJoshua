...
<html lang="es">
  <head>
    ...
    <title>System Phone Joshua</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./escritorio.php" class="logo">
          ...
          <span class="logo-mini"><img src="../files/usuarios/joshua.jpg" class="img-thumbnail" alt=""></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Gestor Logistico</b></span>
        </a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="../ajax/usuario.php?op=salir" class="btn btn-danger">Cerrar</a>
                    </div>
                  </li>
                </ul>
              </li>
        ...
        <section class="sidebar">       
          ...
          <ul class="sidebar-menu">
            ...
            if ($_SESSION['consultav']==1)
            {
              ...
              <ul class="treeview-menu">
                <li id="lConsulasV"><a href="ventasfechacliente.php"><i class="fa fa-circle-o"></i> Consulta Salidas</a></li>                
              </ul>
            </li>';
            }
            ?>
